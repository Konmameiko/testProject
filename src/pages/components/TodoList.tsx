		...
		return (
			<div className={styles.todoList}>
					...
					{this.state.data.map(item => {
						return (
							<li key={item.id} className={styles.list}>
								...
								<button className={styles.delButton} onClick={this.delOne(item.id)}>
									删除
								</button>
							</li>
						);
				...
				<div className={styles.footer}>
					...
					<button className={styles.saveButton} onClick={this.saveAll}>
						保存当前任务
					</button>
					<button className={styles.fotButton} onClick={this.delAll}>
						删除当前所有任务
					</button>
				</div>
			</div>
